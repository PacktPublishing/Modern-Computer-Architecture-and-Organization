...
7. Click **Add Sources** in the **Project Manager** panel, select **Add or create design sources**, and add **https://github.com/PacktPublishing/Modern-Computer-Architecture-and-Organization/blob/master/Chapter%20 2 - Digital Logic/Answers to Exercises/Ex__4_adder4.vhdl** and **https://github.com/PacktPublishing/Modern-Computer-Architecture-and-Organization/blob/master/Chapter%20 2 - Digital Logic/Answers to Exercises/Ex__4_fulladder.vhdl** then click **Finish**.
